...
function uploadImage() {
		...
		document.createUserForm.action ="user.do?method=uploadUserPhoto&userId=<%=cform.getUserId()%>";
...
<html:form action="/user.do?method=uploadUserPhoto" enctype="multipart/form-data">
...
<div align="center" class="msg">
	...
	<tr>
			<td><font color="white"><%=Constant.getResourceStringValue("hr.user.profile.image.updated.successfully",user1.getLocale())%></font></td>
