...
if(boxnu != -1 && boxnu != 99){
	...
	var chechapprovenum=window.opener.document['applicantForm'][approvenum].value;
    var pary = window.opener.document['applicantForm'].idlistvaluser.value;
    ...
    var array1new=new Array();
		...
		if(check1=="false"){
			  var spanstart = '<span  id="approverspan_'+boxnu+'">' + 'Order-'+boxnu+'&nbsp;&nbsp';
			...
			for(var i=0;i<array3.length;i++){
  			...
  			window.opener.document['applicantForm'].idlistvaluser.value=array3new+" "+id_value;
	   ...
	   document.createUserForm.action = "user.do?method=searchapprover&boxnumber=<%=boxnumber%>";
