...
<ul id="menuModel5">
 <% if(menu != null && menu.isAdmin()){%>
	...
	<li id="50009"><a href="#" title="Organization">Organization</a>
		...
		<%}%>
		<% if(menu != null && menu.isOrgEmailTmpl()){%>
			<li id="500095"><a href="<%=request.getContextPath()%>/designation.do?method=designationslist" title="Designations">Job titles</a></li>
		<%}%>
		</ul>
	</li>
	<%}%>	
		...
		<%}%>
			...
			<li id="5000011"><a href="#" title="Competency">Competency</a>
				...
				<% if(menu != null && menu.isCompetenciesQuestions()){%>
					...
					<li id="50000114"><a href="<%=request.getContextPath()%>/technicalskills.do?method=technicalskillslist" title="Technical Skills">Technical Skills</a>
					<li id="50000115"><a href="<%=request.getContextPath()%>/education.do?method=educationlist" title="Education">Education</a>
	...
	<li id="50000007"><a href="<%=request.getContextPath()%>/jobtype.do?method=jobtypelist" title="Job Type">Job Type</a>
	<li id="50000008"><a href="<%=request.getContextPath()%>/workshift.do?method=workshiftlist" title="Work Shift">Work Shift</a>
	<li id="50000009"><a href="<%=request.getContextPath()%>/languages.do?method=languageslist" title="Language">Language</a>
	<li id="50000010"><a href="<%=request.getContextPath()%>/licensetype.do?method=licensetypelist" title="License Type">License Type</a>
	<li id="50000011"><a href="<%=request.getContextPath()%>/ethnicrace.do?method=ethnicRaceList" title="Ethnic Race">Ethnic Race</a>
		</ul>
	</li>
