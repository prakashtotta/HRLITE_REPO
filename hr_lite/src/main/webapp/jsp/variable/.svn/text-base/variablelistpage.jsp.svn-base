...
String sort = "variableId"; // default don't sort
...
List dataList = BOFactory.getVariableBO().getAllVariableDetailsForPagination(results,startIndex,user1.getSuper_user_key(),dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getVariableBO().getAllVariableDetails(user1.getSuper_user_key());
totalSize = allDataList.size();

System.out.println(totalSize);
String[] fields = {"variableId","variableName","variableCode","variableType","defaultValue","defaultValueDate","createdBy","createdDate"};
