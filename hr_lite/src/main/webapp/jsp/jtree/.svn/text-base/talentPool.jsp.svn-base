...
<title><%=Constant.getResourceStringValue("admin.talentpool.header",user1.getLocale())%></title>
...
<table>
<tr>
<td><%=Constant.getResourceStringValue("admin.talentpool.crate_talent_pool",user1.getLocale())%></td><td width="400px" align="left"></td>
</tr>
<tr>
<td><br><a class="button" href="talentPool.jsp" target='myModal'><%=Constant.getResourceStringValue("hr.button.refresh",user1.getLocale())%></a><br></td><td width="400px" align="left"></td>
</tr>
</table>
<table>
...
<div id="resize">
	...
	<div id="annualWizard">	
			<ul class="simpleTree" id='pdfTree'>		
					<li class="root" id='0'><%=Constant.getResourceStringValue("admin.talentpool.menuheader",user1.getLocale())%>
						<ul>
...
function callJavascriptOpenfunc(id){
	...
	GB_showCenter('Applicants',url, 700,900, messageret1);
...
function addApplicant(){
	...
	GB_showCenter('<%=Constant.getResourceStringValue("aquisition.applicant.createapplicant",user1.getLocale())%>',url, 700,900, messageret1);
