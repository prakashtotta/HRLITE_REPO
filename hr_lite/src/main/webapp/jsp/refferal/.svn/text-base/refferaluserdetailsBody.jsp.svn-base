...
<div align="center" >
	...
	<tr>
			...
			<td> <a class="closelink" href="#" onclick="closewindow()"><font color="white"><%=Constant.getResourceStringValue("hr.button.close_window",locale)%></a></td>
		</tr>
...
%>
<font size="1"><%=Constant.getResourceStringValue("aquisition.applicant.self.submit.terms",locale,orgnames)%></font>
</td>
</tr>
</table>
	<table width="800">
			<tr>
			<td  align="left">
			<input type="button" name="login" value="Accept and Submit" onClick="savedata()" class="button">
			</td>
...
<div id="header">
	<ul id="primary">
		<li><a class="dashtab" href="#">Step 1 > </a></li>
		<li><span  class="dashtab"><b>Step 2 > </b></span></li>
		<li><a class="dashtab" href="#">Final submit</a></li>
	</ul>
	</div>
<div id="main" class="div">
<br>
...
<!--Skills end-->	<br><br>
	...
	<table width="90%">
			<tr>
			<td >
			<input type="button" name="login" value="Previous" onClick="backtoMain()" class="button">
			</td>
			<td  align="right">
			<input type="button" name="login" value="<%=Constant.getResourceStringValue("hr.button.next",locale)%>" onClick="next()" class="button">
			</td>
...
<div id="header">
	<ul id="primary">
		<li><a class="dashtab" href="#">Step 1 > </a></li>
		<li><a class="dashtab" href="#">Step 2 > </a></li>
		<li><span  class="dashtab"><b>Final submit</b></span></li>
	</ul>
	</div>
<div id="main"  class="div">
<br>
...
<p><%=Constant.getResourceStringValue("aquisition.applicant.self.submit.terms",locale,orgnames)%></p>
	...
	<table width="800">
			<tr>
			<td >
			<input type="button" name="login" value="Previous" onClick="back()" class="button">
			</td>
			<td  align="right">
			<input type="button" name="login" value="Accept and Submit" onClick="acceptandsubmit()" class="button">
			</td>
