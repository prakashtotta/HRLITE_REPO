...
<table valign="top" border="0" width="60%">
	...
	<td width="40%"><%=Constant.getResourceStringValue("admin.organization.orglistbody.Organization",user1.getLocale())%></td><td width="60%" align="right"> <%=edu.getPrevOrgName()%></td>
    </tr>
	<tr>
	<td width="40%"><%=Constant.getResourceStringValue("aquisition.applicant.Last_role",user1.getLocale())%></td><td width="60%" align="right"> <%=edu.getRole()%></td>
	</tr>
	<tr>
	<td width="40%"><%=Constant.getResourceStringValue("aquisition.applicant.Reporting_Manager",user1.getLocale())%></td><td width="60%" align="right"> <%=edu.getReportingToName()%></td>
	</tr>
	<tr>
	<td width="40%"><%=Constant.getResourceStringValue("aquisition.applicant.Joining_date",user1.getLocale())%></td><td width="60%" align="right"> <%=edu.getStartdate()%></td>
    </tr>
	<tr>
	<td width="40%"><%=Constant.getResourceStringValue("aquisition.applicant.Relieving_date",user1.getLocale())%></td><td width="60%" align="right"> <%=edu.getEnddate()%></td>
   </tr>
	<tr>
	<td width="40%"><%=Constant.getResourceStringValue("aquisition.applicant.Reason_for_leave",user1.getLocale())%></td><td width="60%" align="right"> <%=edu.getReasonforleave()%></td>
...
<%
String attachurl = "applicantoffer.do?method=actionattachmentaddscr&idvalue="+edu.getPrevOrgDetailsId()+"&action=experience_details_proof_attachment&applicantId="+aform.getApplicantId()+"&secureid="+aform.getUuid();
%>
<tr>
...
<%
		...
		String dleteurl = request.getContextPath()+"/applicantoffer.do?method=deleteattachment&actionname=experience_details_proof_attachment&applicantId="+aform.getApplicantId()+"&secureid="+aform.getUuid()+"&uuid="+actionattach.getUuid();
