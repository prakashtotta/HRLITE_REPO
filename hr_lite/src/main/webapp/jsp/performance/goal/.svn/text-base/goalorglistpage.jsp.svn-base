...
Map m = BOFactory.getGoalBO().getOrgGoalsForPagination(new Long(orgId).longValue(),results,startIndex,dir_str,sort_str);
...
String[] fields = {"goalId","goalName","goalDesc","createdDate","createdBy","goalType","departmentName","designationName","timeperiodName"};
