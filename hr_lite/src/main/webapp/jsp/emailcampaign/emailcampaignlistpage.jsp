...
String sort = "emailCampaignId"; // default don't sort
...
List dataList =BOFactory.getEmailCampaignBO().getAllEmailCampaignForPagination(user1,results,startIndex,dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getEmailCampaignBO().getAllEmailCampaignDetails(user1);

totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"emailCampaignId","emailCampaignName","emailCampaignDesc","emailCampaignemail","emailCampaignFormat","status","smtpserver","smtpuser","smptoport"};
