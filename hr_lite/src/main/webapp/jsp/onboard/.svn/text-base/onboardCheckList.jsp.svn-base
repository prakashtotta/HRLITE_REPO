...
<table width="100%">
 <tr bgcolor=#f3f3f3>
		<td><b>On boarding date : </b><b><%=DateUtil.convertDateToStringDate(onboard.getOnBoardingDate(),datepattern)%></b></td>
		<td>Status :
		...
		<a href="#" onClick="printonboarding()"><img border="0" src="jsp/images/print.gif"></a>
		</td>
	</tr>
</table>
