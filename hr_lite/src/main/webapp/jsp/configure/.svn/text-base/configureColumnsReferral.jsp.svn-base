...
<SCRIPT>
 ...
 document.configureColumnsForm.action = "configureColumns.do?method=configureColumnsReferralSave&todata="+todata+"&fromdata="+fromdata;
...
<br>
<BODY>
<html:form action="/configureColumns.do?method=configureColumnsReferralSave" >
<table>
<tr>
<td width="20%"></td>
<td></td>
