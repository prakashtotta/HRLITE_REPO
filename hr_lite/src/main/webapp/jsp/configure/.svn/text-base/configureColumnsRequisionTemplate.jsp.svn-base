...
<SCRIPT>
 ...
 document.configureColumnsForm.action = "configureColumns.do?method=configureColumnsAllRequisitionTemplateSave&todata="+todata+"&fromdata="+fromdata;
...
<br>
<BODY>
<html:form action="/configureColumns.do?method=configureColumnsHriringMgrSave" >
<table>
<tr>
<td width="20%"></td>
<td></td>
