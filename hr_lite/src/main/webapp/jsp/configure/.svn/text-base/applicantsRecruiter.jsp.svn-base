...
<SCRIPT>
 ...
 document.configureColumnsForm.action = "configureColumns.do?method=configureColumnsRecruiterSave&todata="+todata+"&fromdata="+fromdata;
...
<br>
<BODY>
<html:form action="/configureColumns.do?method=configureColumnsRecruiterSave" >
<table>
<tr>
<td width="20%"></td>
<td width="35%"></td>
