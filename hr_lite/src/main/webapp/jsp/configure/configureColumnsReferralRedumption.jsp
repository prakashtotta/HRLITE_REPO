...
<SCRIPT>
 ...
 document.configureColumnsForm.action = "configureColumns.do?method=configureColumnsReferralRedumptionSave&todata="+todata+"&fromdata="+fromdata;
...
<br>
<BODY>
<html:form action="/configureColumns.do?method=configureColumnsReferralRedumptionSave" >
<table>
<tr>
<td width="20%"></td>
<td></td>
...
<div id="slistbox" STYLE="position:absolute; left:110px; top:33px;  width:150px; height:30px;">
<%=Constant.getResourceStringValue("avilable.columns",user1.getLocale())%>
</div>
<div id="dlistbox" STYLE="position:absolute; left:310px; top:33px;  width:150px; height:30px;">
