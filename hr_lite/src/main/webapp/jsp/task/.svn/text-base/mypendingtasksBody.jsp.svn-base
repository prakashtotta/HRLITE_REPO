...
<li><a href="dashboard.do?method=dashboardlist" rel="countrycontainer" class="button"><%=Constant.getResourceStringValue("task.myinterview.dashboard",user1.getLocale())%></a></li>
<li><a href="lov.do?method=callist" rel="countrycontainer" class="button"><%=Constant.getResourceStringValue("task.interview",user1.getLocale())%></a></li>
<li><a href="task.do?method=mypendingtasks" rel="countrycontainer" class="selected button"><%=Constant.getResourceStringValue("task.mypendingtasks.title.mypendingtask",user1.getLocale())%></a></li>
