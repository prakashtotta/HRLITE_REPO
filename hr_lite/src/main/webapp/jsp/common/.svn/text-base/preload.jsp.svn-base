...
// You may modify the following:
	var locationAfterPreload = "<%=reurl%>" // URL of the page after preload finishes
	...
	var yourImages = new Array("http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif","http://localhost:8081/hr/jsp/images/loading.gif")
...
<center>
<font size="4">Please wait...</font><p>
0%
...
document.write('<p><small><a href="javascript:window.location=locationAfterPreload">Skip Preloading</a></p>')
// end hiding -->
</script>
</center>
