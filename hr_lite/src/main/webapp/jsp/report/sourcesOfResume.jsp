...
function runreport(){
	...
	var tu = "/jsp/report/source_of_resume.jsp?reportfilename=Sources_of_resumes.jasper&orgids="+orgids+"&deptids="+deptids+"&hiringMgrIds="+hiringmgrids+"&year="+years;
...
<br>
<span id="reportdata">
<h3><%=Constant.getResourceStringValue("home.Reports.Sources_of_Resume",user2.getLocale())%></h3>
<br>
