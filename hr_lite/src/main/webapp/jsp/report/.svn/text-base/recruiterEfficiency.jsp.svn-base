...
function runreport(){
    ...
    var deptids="";
    var years="";
    var recruiterids= $('input[name="users"]').val();
	...
	/// alert(recruiterids);
	var tu = "/jsp/report/recruiter_efficiency.jsp?reportfilename=Recruiter_Efficiency1.jasper&orgids="+orgids+"&deptids="+deptids+"&recruiterIds="+recruiterids+"&year="+years;
...
<br>
<span id="reportdata">
<h3><%=Constant.getResourceStringValue("home.Reports.Recruiter_Efficiency",user2.getLocale())%></h3>
<br>
