...
%>
<html>
<head><title><%=Constant.getResourceStringValue("home.Reports.report",user1.getLocale())%> <%=Constant.getResourceStringValue("home.Reports.Declined_offer_Ratio",user1.getLocale())%></title>
</head>
<%
	...
	String year = (String)request.getParameter("year");
    	...
    	//parameters.put("Year",  new Integer("2012"));	
...
Connection conn = HibernateUtil.createSQLConnection(); 
		...
		session.setAttribute("declinedoffer", jasperPrint);
    ...
    String imageuri = request.getContextPath()+"/reports/dashboardimage?dashboard=declinedoffer&ver="+new java.util.Date().getTime() +"&image=";
...
<table>
<tr>
<td align="right">&nbsp;<a href="<%=request.getContextPath()%>/reports/xls?cmd=declinedOffer&reportfilename=<%=reportfilename%>&orgids=<%=orgIds%>&deptids=<%=deptIds%>&hiringMgrIds=<%=hiringmgrIds%>&year=<%=year%>" target="new"><img src="../images/xls_icon.jpg" border="0" width="18" height="18"></a></td>
<td align="right">&nbsp;<a href="<%=request.getContextPath()%>/reports/pdf?cmd=declinedOffer&reportfilename=<%=reportfilename%>&orgids=<%=orgIds%>&deptids=<%=deptIds%>&hiringMgrIds=<%=hiringmgrIds%>&year=<%=year%>" target="new"><img src="../images/PDF_icon.jpg" border="0" width="18" height="18"></a></td>
