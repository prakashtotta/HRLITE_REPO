...
function runreportApplicantOffer(){
    var orgids ="";
    var deptids="";
    var years ="";
	...
	if(hiringmgrids == null || hiringmgrids == ""){
		hiringmgrids = 0;
	}
	if(recruiterids == null || recruiterids == ""){
		recruiterids = 0;
	}
	if(years == null || years == ""){
		years=0;
	...
	//&orgids="+orgids+"&deptids="+deptids+"&hiringMgrIds="+hiringmgrids+"&year="+years;
	
	var tu = "/jsp/report/applicant_offer_ratio.jsp?reportfilename=Applicant_offered_ratio.jasper&orgids="+orgids+"&deptids="+deptids+"&hiringMgrIds="+hiringmgrids+"&recruiterIds="+recruiterids+"&year="+years;
