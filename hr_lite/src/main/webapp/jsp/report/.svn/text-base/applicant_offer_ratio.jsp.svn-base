...
%>
<html>
<head><title><%=Constant.getResourceStringValue("home.Reports.report",user1.getLocale())%> <%=Constant.getResourceStringValue("home.Reports.Applicant_offered_ratio",user1.getLocale())%></title>
</head>
<%
...
<table>
<tr>
<td align="right">&nbsp;<a href="<%=request.getContextPath()%>/reports/xls?cmd=applicantOfferRatio&reportfilename=<%=reportfilename%>&orgids=<%=orgIds%>&deptids=<%=deptIds%>&hiringMgrIds=<%=hiringmgrIds%>&requitionIds=<%=requitionIds%>&year=<%=year%>" target="new"><img src="../images/xls_icon.jpg" border="0" width="18" height="18"></a></td>
<td align="right">&nbsp;<a href="<%=request.getContextPath()%>/reports/pdf?cmd=applicantOfferRatio&reportfilename=<%=reportfilename%>&orgids=<%=orgIds%>&deptids=<%=deptIds%>&hiringMgrIds=<%=hiringmgrIds%>&requitionIds=<%=requitionIds%>&year=<%=year%>" target="new"><img src="../images/PDF_icon.jpg" border="0" width="18" height="18"></a></td>
