...
function runreport(){
	...
	var tu = "/jsp/report/offer_vs_acceptance.jsp?reportfilename=Offer_Vs_Acceptance.jasper&orgids="+orgids+"&deptids="+deptids+"&hiringMgrIds="+hiringmgrids+"&year="+years;
...
<br>
<span id="reportdata">
<h3><%=Constant.getResourceStringValue("home.Reports.Offer_Vs_Acceptance",user2.getLocale())%></h3>
<br>
