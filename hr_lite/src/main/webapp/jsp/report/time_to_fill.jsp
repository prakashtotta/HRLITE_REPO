...
%>
<html>
<head><title><%=Constant.getResourceStringValue("home.Reports.report",user1.getLocale())%> <%=Constant.getResourceStringValue("home.Reports.Time_To_Fill",user1.getLocale())%></title>
</head>
<%
	...
	String reportfilename = (String)request.getParameter("reportfilename");
		...
		String requitionIds = (String)request.getParameter("requitionIds");
		String jobGradeIds= (String)request.getParameter("jobGradeIds");
...
<table>
<tr>
<td align="right">&nbsp;<a href="<%=request.getContextPath()%>/reports/xls?cmd=timeToFill&reportfilename=<%=reportfilename%>&orgids=<%=orgIds%>&deptids=<%=deptIds%>&hiringMgrIds=<%=hiringmgrIds%>&year=<%=year%>&recruiterIds=<%=recruiterIds%>&requitionIds=<%=requitionIds%>&jobGradeIds=<%=jobGradeIds%>" target="new"><img src="../images/xls_icon.jpg" border="0" width="18" height="18"></a></td>
<td align="right">&nbsp;<a href="<%=request.getContextPath()%>/reports/pdf?cmd=timeToFill&reportfilename=<%=reportfilename%>&orgids=<%=orgIds%>&deptids=<%=deptIds%>&hiringMgrIds=<%=hiringmgrIds%>&year=<%=year%>&recruiterIds=<%=recruiterIds%>&requitionIds=<%=requitionIds%>&jobGradeIds=<%=jobGradeIds%>" target="new"><img src="../images/PDF_icon.jpg" border="0" width="18" height="18"></a></td>
