...
function runreport(){
	...
	var tu = "/jsp/report/applicant_offer_ratio.jsp?reportfilename=Applicant_offered_ratio.jasper&orgids="+orgids1+"&deptids="+deptids+"&hiringMgrIds="+hiringmgrids+"&year="+years+"&requitionIds="+requitionIds;
...
<table border="0" width="100%"class="div">
		...
		<tr>
			<td width="200"><input type="button" name="runreport1" value="<%=Constant.getResourceStringValue("hr.button.run",user2.getLocale())%>" onClick="runreport()" class="button"></td>
