...
DataTableBean dtbean = BOFactory.getJobRequistionBO().jobRequistionsAssignedToMeAsRecruiterForPagination(currentuserid,results,startIndex,dir_str,sort_str);
