...
List appList = BOFactory.getApplicantBO().getApplicantsByInterviewStateAndOfferDeclinedDate(user1,Common.OFFER_DECLINED,new Integer(noofdaysoffset).intValue());
