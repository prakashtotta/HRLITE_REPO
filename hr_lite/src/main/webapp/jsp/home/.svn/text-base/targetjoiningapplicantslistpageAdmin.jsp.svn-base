...
DataTableBean dtbean = BOFactory.getApplicantBO().applicantsByInterviewStateAndTargetJoiningDateAdmin(user1, interviewstate,new Integer(noofdaysoffset).intValue(),results,startIndex,dir_str,sort_str);
