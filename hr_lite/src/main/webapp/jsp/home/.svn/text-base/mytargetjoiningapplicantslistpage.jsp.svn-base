...
DataTableBean dtbean = BOFactory.getApplicantBO().applicantsByInterviewStateAndTargetJoiningDate(user1, interviewstate,new Integer(noofdaysoffset).intValue(),results,startIndex,dir_str,sort_str);
