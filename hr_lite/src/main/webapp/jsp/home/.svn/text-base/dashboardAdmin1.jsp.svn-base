...
<HEAD>
	...
	*/
	...
	,	resizeWithWindowDelay:	100		// delay calling resizeAll when window is *still* resizing
...
GB_showCenter('<%=Constant.getResourceStringValue("aquisition.applicant.configure.columns",user.getLocale())%>',url,450,700, messageret);
}
...
&nbsp;&nbsp;<a  style="color: blue;" href="jobreq.do?method=myjobreqList" ><%=Constant.getResourceStringValue("Requisition.my.requistions",user.getLocale())%></a>
&nbsp;&nbsp;<a  style="color: blue;" href="#" onClick="configuredashboard()"><%=Constant.getResourceStringValue("hr.user.configure.dashboard",user.getLocale())%></a>
				</DIV>
			</DIV>
...
<DIV class="ui-layout-north">
	<DIV class="ui-widget-header ui-corner-top">West-North satya</DIV>
