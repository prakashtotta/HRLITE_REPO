...
$.ajax({
	type: 'GET',
  url: "jsp/home/targetSlipingDateRecruiter.jsp"+"?ddd="+(new Date).getTime(),
...
$.ajax({
	type: 'GET',
  url: "jsp/home/filledActiveRequistionRecruiter.jsp"+"?ddd="+(new Date).getTime(),
  success: function(data){
...
$.ajax({
	type: 'GET',
  url: "jsp/home/onBoradJoinedRecruiter.jsp"+"?ddd="+(new Date).getTime(),
  success: function(data){
...
$.ajax({
	type: 'GET',
  url: "jsp/home/reqOpenStatus.jsp"+"?type=recruiter&ddd="+(new Date).getTime(),
  success: function(data){
...
function approveOffer(idvalue,uuid,tasktype,action){
	...
	if(action == "approve"){
		...
		GB_showCenter('<%= Constant.getResourceStringValue("aquisition.applicant.Reject_offer",user.getLocale())%>',url,400,600, messageretrefresh);
	}
}
