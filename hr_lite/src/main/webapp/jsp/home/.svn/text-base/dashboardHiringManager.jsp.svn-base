...
&nbsp;&nbsp;<a  href="jobreq.do?method=myjobreqList" ><%=Constant.getResourceStringValue("Requisition.my.requistions",user1.getLocale())%></a>
...
<td valign="top" width="25%">
   ...
   <div style="background: #f3f3f3;"><a href="#" rel="toggle[assinedreq]" data-openimage="jsp/images/Collapsed.gif" data-closedimage="jsp/images/Expanded.gif"><img src="jsp/images/Expanded.gif" border="0" /></a> My active requisitions </div>
...
<div style="background: #f3f3f3;"><a href="#" rel="toggle[applicantjoiningprocess]" data-openimage="jsp/images/Collapsed.gif" data-closedimage="jsp/images/Expanded.gif"><img src="jsp/images/Expanded.gif" border="0" /></a> Offer accepted applicants (joining within 90 days) </div>
...
<!-- Offer accepted applicants (joining within 30 days) -->
   ...
   <div class="title_box">Requistions Slipping target</div>  
   <div class="border_box">
