...
List appList = BOFactory.getApplicantBO().getApplicantsByInterviewStateAndOfferDeclinedDateAdmin(user1,Common.OFFER_DECLINED,new Integer(noofdaysoffset).intValue());
