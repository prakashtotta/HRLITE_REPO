	...
	************************************************************************************************************/	
	...
	switch(floating_window_skin){
		case 2:
			...
			var tabRightInActive = "jsp/floatwindow/images/skin2_tab_right_inactive.gif";
			var tabRightActive = "jsp/floatwindow/images/skin2_tab_right_active.gif";
			var tabImagePrefix = "jsp/floatwindow/images/skin2_tab_right_";		
			var closeButtonMouseOverColor = '#006BF8';
			break;
		default:
			
			var tabRightInActive = "jsp/floatwindow/images/tab_right_inactive.gif";
			var tabRightActive = "jsp/floatwindow/images/tab_right_active.gif";
			var tabImagePrefix = "jsp/floatwindow/images/tab_right_";
	...
	*/	
	...
	function createStatusBar(inputObj,noResize)
	{
		...
		img.src = 'jsp/floatwindow/images/floating_window_resize.gif';
