...
//	Configuration
//
var fileLoadingImage = "jsp/lightbox/images/loading.gif";		
var fileBottomNavCloseImage = "jsp/lightbox/images/closelabel.gif";
	...
	start: function(imageLink) {	
		...
		function getImageTitle(anchor){ //DynamicDrive.com added function that allows the caption("title") to be linked ("rev").
			...
			var ddimageTitleURL=(ddimageTitle!=null && ddimageTitle!="")? anchor.getAttribute('rev') : null
				//var winopenurl = '<a href="window.open('+ddimageTitleURL+')" class="ddcaptionurl">'+ddimageTitle+'</a>';
			var winopenurl = "<a href='#' onClick=window.open("+"'"+ddimageTitleURL+"'"+","+ "'"+"LocationPreview"+ "'"+","+"'"+"location=0,status=0,scrollbars=1,menubar=0,resizable=1,width=400,height=400"+"'"+")>"+ddimageTitle+"</a>";
			return ddimageTitleFinal=(ddimageTitleURL!=null && ddimageTitleURL!="")? winopenurl : ddimageTitle
		};
