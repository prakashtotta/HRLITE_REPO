...
List dataList = BOFactory.getOrganizationBO().getDeptsByOrgForPagination(new Long(orgId).longValue(),results,startIndex,dir_str,sort_str);


int totalSize = 0;

totalSize = BOFactory.getOrganizationBO().getCountOfDeptsByOrg(new Long(orgId).longValue());

	


String[] fields = {"departmentId","departmentName","departmentCode","departmentDesc","organizationname"};
