...
List dataList = BOFactory.getOrganizationBO().getChildOrganizationsForPagination(user1.getSuper_user_key(),new Long(orgId).longValue(),results,startIndex,dir_str,sort_str);


int totalSize = 0;

totalSize = BOFactory.getOrganizationBO().getCountOfChildOrganizations(user1.getSuper_user_key(),new Long(orgId).longValue());

	


String[] fields = {"orgId","orgCode","orgName","locationCodeValue","locationValue","organizationTypeValue","currencyCode","parent_org_id","parentOrgName"};
