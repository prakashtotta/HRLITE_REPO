...
//	totalSize = ApplicantBO.getCountOfsearchOwnRefferalApplicant(user1,fullname,reqid,prevorg,email,appdate,cri,applicantNo);
	...
	dataList = RefBO.searchOwnAgencyRedemptionsForPagination(user1,applicantname,results,startIndex,dir_str,sort_str);
	totalSize = RefBO.getCountOfsearchOwnAgencyRedemptions(user1,applicantname);
}
	

System.out.println(totalSize);
String[] fields = {"agredid","applicantName","JobTitle","refferalSchemeName","refferalSchemeAmount","uom","refferalSchemeTypeName","ruleName","state","applicantstate","eventdate","releaseddate","uuid"};
