...
List dataList = BOFactory.getJobRequistionBO().getAllJobRequistionsByOrgByDeptForPagination(orgId,deptId,results,startIndex,dir_str,sort_str);


int totalSize = 0;

totalSize = BOFactory.getJobRequistionBO().getCountOfAllJobRequistionsByOrgByDept(orgId,deptId);
