...
dataList = BOFactory.getLocationBO().getAllLocationDetailsForPagination(user1,locationname,locationcode,countryid,stateid,city,results,startIndex,dir_str,sort_str);
totalSize = BOFactory.getLocationBO().getCountOfAllLocations(user1,locationname,locationcode,countryid,stateid,city);



String[] fields = 

{"locationId","locationName","locationCode","zip","phone","fax","city","countryName","stateName","regionName"};
