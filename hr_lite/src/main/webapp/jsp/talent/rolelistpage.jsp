...
String sort = "roleId"; // default don't sort
...
List dataList = BOFactory.getRoleBO().getAllRolesForPagination(user1,results,startIndex,dir_str,sort_str);


int totalSize = 0;

List allDataList = BOFactory.getRoleBO().getAllRoles(user1.getSuper_user_key());
totalSize = allDataList.size();

String[] fields = {"roleId","roleCode","roleName","roleDesc","createdBy"};
