...
String sort = "membershipTypeId"; // default don't sort
...
List dataList = BOFactory.getLovBO().getAllMembershipTypeDetailsForPagination(user1,results,startIndex,dir_str,sort_str);
System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getLovBO().getAllMembershipTypeDetails(user1);
totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"membershipTypeId","membershipTypeName","membershipTypeDesc","status"};
