...
<td>
<!-- attachements -->
<table valign="top" border="0" width="50%">
<%
...
<%
		...
		String dleteurl = request.getContextPath()+"/applicant.do?method=deleteApplicantattachment&actionname=experience_details_proof_attachment&applicantId="+aform.getApplicantId()+"&secureid="+aform.getUuid()+"&uuid="+actionattach.getUuid();
