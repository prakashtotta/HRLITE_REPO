...
List dataList = BOFactory.getApplicantBO().getApplicantsForPaginationByUser(user1,results,startIndex,dir_str,sort_str);


int totalSize = 0;

totalSize = BOFactory.getApplicantBO().getCountOfMyApplicants(user1);
