...
String baseUrlForJobboard1 = Constant.getValue("external.url")+"jobs.do?method=jobdetailsn&reqid="+jobreqform.getJobreqId()+"&secureid="+jobreqform.getUuid();
...
/*function savepublishinfodata(){
	//alert(document.jobRequisitionForm.juju.checked);
	...
	//alert("juju >>"+juju +" olx >>"+olx +" oodle >>"+oodle+" trovit >>"+trovit+" twitjobsearch >>"+twitjobsearch+" workhound >>"+workhound+" yakaz >>"+yakaz);

	
	
	document.jobRequisitionForm.action = "jobreq.do?method=savepublishinfo&jobreqId="+'<bean:write name="jobRequisitionForm" property="jobreqId"/>'+"&juju="+juju+"&olx="+olx+"&oodle="+oodle+"&trovit="+trovit+"&twitjobsearch="+twitjobsearch+"&workhound="+workhound+"&yakaz="+yakaz+"&indeed="+indeed+"&simplyhired="+simplyhired+"&jooble="+jooble+"&careervital="+careervital+"&jobdiesel="+jobdiesel;
...
<div align="center" class="msg">
	...
	<tr>
			...
			<font color="white"><%=Constant.getResourceStringValue("Requisition.publishinfo.saved",user1.getLocale())%></font></td>
			<td> </td>
		</tr>
...
<div align="center" class="msg">
	...
	<tr>
			<td><font color="white"><%=Constant.getResourceStringValue("hr.user.Vendor_deleted_succ",user1.getLocale())%></font></td>
			<td> </td>
		</tr>
...
<%
		if(jobreqform.getPublishToExternal()!=null && jobreqform.getPublishToExternal().equals("Y")){%>
         <input type="checkbox" name="publishToExternal" id="publishToExternal" value="Y" checked="true" readonly="true" class="titleHintBox"  title="<%=Constant.getResourceStringValue("Requisition.publishToExternal.help",user1.getLocale())%>"/>
		<%}else{%>
		 <input type="checkbox" name="publishToExternal" id="publishToExternal" value="Y" checked="true" readonly="true" class="titleHintBox"  title="<%=Constant.getResourceStringValue("Requisition.publishToExternal.help",user1.getLocale())%>"/>
		<% }%>
...
<tr>
	...
	<td><%=jobreqform.getPublishedComment()%></td>
</tr>
...
<tr>
	...
	<input type="checkbox" align="bottom" name="yakaz" id="yakaz" checked="true" value="" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/yakaz.GIF" align="top" height="30" width="70" border="0" title="Yakaz"></img>
	<%}else{ %>
	...
	<input type="checkbox" align="bottom" name="jobdiesel" id="jobdiesel" checked="true" value="" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/jobdiesel.png" align="top" height="40" width="130" border="0" title="Job Diesel"></img>
	<%}else{ %>
...
<tr>
	...
	<input type="checkbox" align="bottom" disabled="true" name="olx" id="olx"  value="" checked="true" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/olxfeed_logo.gif" align="top" height="30" width="30" border="0" title="Olx"></img>
	...
	<input type="checkbox" align="bottom" disabled="true" name="oodle" id="oodle"  value="" checked="true" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/oodle.GIF" align="top" height="30" width="70" border="0" title="Oodle"></img>
	<%}else{ %>
	...
	<input type="checkbox" align="bottom" disabled="true" name="trovit" id="trovit"  value="" checked="true" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/trovit.gif" align="top" height="30" width="70" border="0" title="Trovit"></img>
	<%}else{ %>	
	...
	<input type="checkbox" align="bottom" disabled="true" name="simplyhired" id="simplyhired" checked="true"  value="" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/simplyhired_logo.GIF" align="top" height="30" width="90" border="0" title="SimplyHired"></img>
	<%}else{ %>	
	...
	<input type="checkbox" align="bottom" disabled="true" name="careervital" id="careervital" checked="true"  value="" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/careerVital.gif" align="top" height="30" width="90" border="0" title="careervitals"></img>
	<%}else{ %>	
	...
	<input type="checkbox" align="bottom" disabled="true" name="twitjobsearch" id="twitjobsearch" checked="true" value="" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/twitjobsearch.GIF" align="top" height="30" width="120" border="0" title="TwitJobSearch"></img>
	<%}else{ %>	
	...
	<input type="checkbox" align="bottom" disabled="true" name="workhound" id="workhound" checked="true" value="" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/workhound.GIF" align="top" height="30" width="100" border="0" title="Workhound"></img></td>
	<%}else{ %>
	<input type="checkbox" align="bottom" disabled="true" name="workhound" id="workhound"  value="" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/workhound.GIF" align="top" height="30" width="100" border="0" title="Workhound"></img></td>
	...
	<input type="checkbox" align="bottom" disabled="true" name="indeed" id="indeed" checked="true" value="" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/indeed.GIF" align="top" height="30" width="70" border="0" title="Indeed"></img>
	<%}else{ %>
	...
	<input type="checkbox" align="bottom" disabled="true" name="jooble" id="jooble" checked="true" value="" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/jooble.gif" align="top" height="30" width="70" border="0" title="jooble"></img>
	<%}else{ %>
	...
	<input type="checkbox" align="bottom" disabled="true" name="juju" id="juju"  value="" checked="true" class="titleHintBox"  title=""/>&nbsp;&nbsp;<img src="jsp/images/juju.GIF" align="top" height="30" width="70" border="0" title="Juju"></img>
	<%}else{ %>
...
Job requisition url :<input type="text" name="joblink"  size="100"  value="<%=baseUrlForJobboard1%>"/>
