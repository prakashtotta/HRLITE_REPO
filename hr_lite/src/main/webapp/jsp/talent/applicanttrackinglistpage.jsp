...
List dataList = BOFactory.getApplicantBO().getApplicantsTrackingByStatusPaginationByUser(user1,status,results,startIndex,dir_str,sort_str);


int totalSize = 0;

totalSize = BOFactory.getApplicantBO().getCountOfApplicantsTrackingByStatus(user1,status);

	

System.out.println(totalSize);
String[] fields = {"applicantId","fullName","email","phone","countryName","city","heighestQualification","qualifications","interviewState","appliedDate","resumeHeader","jobTitle","referrerName","ownername","uuid","createdBy"};
