...
List dataList = BOFactory.getLovBO().getEvaluationTmplListForPagination(results,startIndex,dir_str,sort_str);


int totalSize = 0;


totalSize = BOFactory.getLovBO().getCountOfAllEvaluationTemplates();
	


String[] fields = {"evtmplId","evTmplName","createdBy","createdDate"};
