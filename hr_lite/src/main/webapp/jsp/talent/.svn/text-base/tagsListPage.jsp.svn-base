...
String tagsname = (String)request.getParameter("tagsname");
...
int totalSize = 0;
	...
	dataList=BOFactory.getTagsBO().getAllTagsForPaginationBySearchCriteria(user1,tagsname,type,results,startIndex,dir_str,sort_str);
    dataListsize= BOFactory.getTagsBO().getAllTagsBySearchCriteria(user1,tagsname,type);
