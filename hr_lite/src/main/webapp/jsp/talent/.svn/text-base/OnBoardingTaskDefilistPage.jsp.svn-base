...
List dataList = OnBoardingTaskDefiBO.getAllOnBoardingTaskDefiForPagination(results,startIndex,dir_str,sort_str);

int totalSize = 0;

List allDataList = OnBoardingTaskDefiBO.getAllOnBoardingTaskDefiDetails();
totalSize = allDataList.size();

	

System.out.println(totalSize);
String[] fields = {"taskdefid","taskName","taskDesc","primaryOwnerValue","eventType","createdBy","createdDate"}; 
