...
String sort = "accId"; // default don't sort
...
String accomplishmentName = (String)request.getParameter("accomplishmentName");
System.out.println("accomplishmentName : "+accomplishmentName);
...
List dataList = BOFactory.getAccomplishmentBO().getAllAccopmlishmentDetailsForPagination(user1,results,startIndex,dir_str,sort_str,accomplishmentName);


int totalSize = 0;

List allDataList = BOFactory.getAccomplishmentBO().getAllAccopmlishmentDetails(user1,accomplishmentName);  
totalSize = allDataList.size();

	

System.out.println(totalSize);
String[] fields = {"accId","accName","accDesc","status"};
