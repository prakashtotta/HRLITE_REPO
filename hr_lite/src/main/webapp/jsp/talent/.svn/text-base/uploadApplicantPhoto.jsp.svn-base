...
function uploadImage() {
		...
		document.applicantForm.action ="applicant.do?method=uploadApplicantPhoto&applicantId=<%=form.getApplicantId()%>&secureid=<%=form.getUuid()%>";
...
<html:form action="/applicant.do?method=uploadApplicantPhoto" enctype="multipart/form-data">
