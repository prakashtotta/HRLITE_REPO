...
List dataList = BOFactory.getSalaryBO().getAllSalaryDetailsForPagination(user1,results,startIndex,dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getSalaryBO().getAllSalaryDetails(user1);
totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"salaryplanId","salaryPlanName","salaryPlanDesc","fromRangeAmount","toRangeAmount","currencyCode","salaryPlanYear"};
