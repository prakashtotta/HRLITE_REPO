...
function discard(){
 ...
 function updatedata(){
	  ...
	  document.applicantForm.action = "applicantoffer.do?method=sendoffermodifficationrequest&applicantId=<%=aform.getApplicantId()%>&secureid=<%=aform.getUuid()%>";
...
<html:form action="/applicantoffer.do?method=sendoffermodifficationrequest">
<%
...
<div align="center" class="msg">
	...
	<tr>
			<td><font color="white">Modifification request sent for review.</font></td>
			<td></td>
		</tr>
...
<tr>
		...
		<tr>
			...
			<input type="button" name="login" value="send for review" onClick="updatedata()" class="button">
			
			</td>
			<td><input type="button" name="login" value="cancel" onClick="discard()" class="button"></td>
		</tr>
