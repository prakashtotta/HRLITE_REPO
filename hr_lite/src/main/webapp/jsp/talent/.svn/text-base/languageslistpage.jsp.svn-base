...
String sort = "languageId"; // default don't sort
...
List dataList =BOFactory.getLovBO().getAllLanguagesForPagination(user1,results,startIndex,dir_str,sort_str,languageName);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getLovBO().getAllLanguagesDetails(user1,languageName);

totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"languageId","languageName","languageDesc","status"};
