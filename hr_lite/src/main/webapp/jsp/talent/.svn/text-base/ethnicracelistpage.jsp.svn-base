...
String sort = "ethnicRaceId"; // default don't sort
...
List dataList =BOFactory.getLovBO().getAllEthnicRaceForPagination(user1,results,startIndex,dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getLovBO().getAllEthnicRaceDetails(user1);

totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"ethnicRaceId","ethnicRaceName","ethnicRaceDesc","status"};
