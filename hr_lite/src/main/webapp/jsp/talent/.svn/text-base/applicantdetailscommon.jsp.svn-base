...
<table border="0" width="100%">
	<font color = red ><html:errors /> </font>
		...
		<tr>
			...
			&nbsp;&nbsp;&nbsp;
			<a  href="#" onclick="downloadapplicantdetails();return false"><img src="jsp/images/PDF_icon.jpg" border="0" alt="Close" title="Download Applicant Details" height="25"  width="24"/></a>
&nbsp;&nbsp;&nbsp;
...
<div class="msg"><a href="#" rel="toggle[applicantpersonalinfo]" data-openimage="jsp/images/Collapsed.gif" data-closedimage="jsp/images/Expanded.gif"><img src="jsp/images/Expanded.gif" border="0" /></a> <%=Constant.getResourceStringValue("aquisition.applicant.personalinfo",user1.getLocale())%>  </div>
...
<div class="msg"><a href="#" rel="toggle[sourcesubsource]" data-openimage="jsp/images/Collapsed.gif" data-closedimage="jsp/images/Expanded.gif"><img src="jsp/images/Expanded.gif" border="0" /></a> <%=Constant.getResourceStringValue("aquisition.applicant.resumesource",user1.getLocale())%>  </div>
...
<br/>
<fieldset>
<div class="msg"><a href="#" rel="toggle[eeoinfo]" data-openimage="jsp/images/Collapsed.gif" data-closedimage="jsp/images/Expanded.gif"><img src="jsp/images/Expanded.gif" border="0" /></a> EEO Informations  </div>
...
<div class="msg"><a href="#" rel="toggle[workpreferenceappdetails]" data-openimage="jsp/images/Collapsed.gif" data-closedimage="jsp/images/Expanded.gif"><img src="jsp/images/Expanded.gif" border="0" /></a> <%=Constant.getResourceStringValue("aquisition.applicant.workpreference",user1.getLocale())%>  </div>
...
<fieldset>
<div class="msg"><a href="#" rel="toggle[applicanteducation]" data-openimage="jsp/images/Collapsed.gif" data-closedimage="jsp/images/Expanded.gif"><img src="jsp/images/Expanded.gif" border="0" /></a> <%=Constant.getResourceStringValue("aquisition.applicant.education",user1.getLocale())%>  </div>
...
<!-- fifth section start -->
<fieldset>
<div class="msg"><a href="#" rel="toggle[applicantsocial]" data-openimage="jsp/images/Collapsed.gif" data-closedimage="jsp/images/Expanded.gif"><img src="jsp/images/Expanded.gif" border="0" /></a> <%=Constant.getResourceStringValue("aquisition.applicant.social",user1.getLocale())%>  </div>
...
<fieldset>
<div class="msg"><a href="#" rel="toggle[applicantbackground]" data-openimage="jsp/images/Collapsed.gif" data-closedimage="jsp/images/Expanded.gif"><img src="jsp/images/Expanded.gif" border="0" /></a> Background  </div>
...
<fieldset>
<div class="msg"><a href="#" rel="toggle[moreapplicantdetails]" data-openimage="jsp/images/Collapsed.gif" data-closedimage="jsp/images/Expanded.gif"><img src="jsp/images/Expanded.gif" border="0" /></a> <%=Constant.getResourceStringValue("aquisition.applicant.more.details",user1.getLocale())%>  </div>
