...
String sort = "jobTypeId"; // default don't sort
...
List dataList =BOFactory.getLovBO().getAllJobTypeForPagination(user1,results,startIndex,dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getLovBO().getAllJobTypeDetails(user1);

totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"jobTypeId","jobTypeName","jobTypeDesc","status"};
