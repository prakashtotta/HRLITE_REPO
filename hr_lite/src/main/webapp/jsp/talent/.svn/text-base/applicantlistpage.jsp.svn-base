...
List dataList = BOFactory.getApplicantBO().getApplicantsForPagination(results,startIndex,dir_str,sort_str);


int totalSize = 0;

totalSize = BOFactory.getApplicantBO().getCountOfAllApplicants();

	

System.out.println(totalSize);
String[] fields = {"applicantId","fullName","email","phone","city","heighestQualification","interviewState","appliedDate","jobTitle","ownername","uuid","resumeSourceTypeStr"};
