...
String catgname = (String)request.getParameter("categorygname");
...
int totalSize = 0;
	...
	dataList=CatagoryBO.getAllCatagoryForPaginationBySearchCriteria(user1,catgname,results,startIndex,dir_str,sort_str);
    dataListsize= CatagoryBO.getAllCatagoryBySearchCriteria(user1,catgname);
