...
parent.parent.GB_hide();
 ...
 function updatedata(){
	  ...
	  document.applicantForm.action = "applicant.do?method=acceptofferOnBehalf&applicantId=<%=aform.getApplicantId()%>&secureid=<%=aform.getUuid()%>";
...
<html:form action="/applicant.do?method=acceptofferOnBehalf">
<%
...
<div align="center" class="msg">
	...
	<tr>
			<td><font color="white"><%=Constant.getResourceStringValue("Offer_Accepted_On_behalf_of",user1.getLocale())%></font></td>
...
<tr>
		...
		<tr>
			...
			<input type="button" name="login" value=" <%=Constant.getResourceStringValue("aquisition.applicant.accept_offer",user1.getLocale())%>" onClick="updatedata()" class="button">
