...
List dataList = SelectionBO.getSelectionsListForPagination(results,startIndex,dir_str,sort_str);


int totalSize = 0;

List allDataList = SelectionBO.getAllSelectionsList();
totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"selId","selName","createdBy","createdDate"};
