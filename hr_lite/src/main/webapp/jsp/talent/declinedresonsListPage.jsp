...
String sort = "offerdeclinedreasonId"; // default don't sort
...
int totalSize = 0;
	...
	dataList=BOFactory.getLovBO().getAllDeclinedReasonsDetailsForPagination(user1,results,startIndex,dir_str,sort_str);
	dataListsize= BOFactory.getLovBO().getAllDeclinedReasonsDetails(user1);
...
{"offerdeclinedreasonId","offerdecliedreasonName","offerdecliedreasonDesc","resonType","status"};
