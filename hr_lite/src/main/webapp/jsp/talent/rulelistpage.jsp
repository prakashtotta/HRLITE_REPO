...
List dataList = BOFactory.getRefferalRuleBO().getAllRefferalRuleDetailsForPagination(user1,results,startIndex,dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getRefferalRuleBO().getAllRefferalRuleDetails(user1);
totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"ruleId","ruleName","ruleDesc","creditAfterdays"};
