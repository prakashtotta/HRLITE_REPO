...
<b><%=Constant.getResourceStringValue("Requisition.search.requisition",user1.getLocale())%> </b> 
...
<table border="0" width="900">
		...
		<tr>
			...
			<html:text  styleClass="multipleselect" property="requisition_number" value=""/>
			<%}else{%>
			<html:text  styleClass="multipleselect" property="requisition_number"/>
			<%}%>
	     </td>
		</tr>
		<tr>
			...
			<td>
			<html:select property="orgIds" styleClass="multipleselect" multiple="true" size="3" onclick="retrieveURL('jobreq.do?method=deptlistmultiple');">
...
<a  class="button" href="#" onClick="addRequisition()"><%=Constant.getResourceStringValue("Requisition.createjobreq",user1.getLocale())%> </a> &nbsp; &nbsp; &nbsp; <a  class="button" href="#" onClick="exportrequistions()"><%=Constant.getResourceStringValue("Requisition.exportrequisitions",user1.getLocale())%></a>&nbsp; &nbsp; &nbsp; <a class="button" href="#" onClick="configuareColumns();return false;"><%=Constant.getResourceStringValue("aquisition.applicant.Configuare_Columns",user1.getLocale())%></a>
