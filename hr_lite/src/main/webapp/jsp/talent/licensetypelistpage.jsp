...
String sort = "licenseTypeId"; // default don't sort
...
List dataList =BOFactory.getLovBO().getAllLicenseTypeForPagination(user1,results,startIndex,dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getLovBO().getAllLicenseTypeDetails(user1);

totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"licenseTypeId","licenseTypeName","licenseTypeDesc","status"};
