...
String sort = "budgetId"; // default don't sort
...
List dataList = BOFactory.getBudgetCodeBO().getAllBudgetDetailsForPagination(user1,results,startIndex,dir_str,sort_str);


int totalSize = BOFactory.getBudgetCodeBO().getCountOfBudgetCodes(user1);

	

System.out.println(totalSize);
String[] fields = {"budgetId","budgetCode","budgetCentreName","budgetamount","orgName","deptName","budgetYear","budgetCurrency"}; 
