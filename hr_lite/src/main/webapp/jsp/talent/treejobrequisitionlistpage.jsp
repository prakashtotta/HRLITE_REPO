...
List dataList = BOFactory.getJobRequistionBO().getMyJobRequistionsByOrgByDeptForPagination(orgId,hiringmgrid,deptId,results,startIndex,dir_str,sort_str);


int totalSize = 0;

totalSize = BOFactory.getJobRequistionBO().getCountOfMyJobRequistionsByOrgByDept(orgId,hiringmgrid,deptId);

	

System.out.println(totalSize);
String[] fields = {"jobreqId","jobreqName","organizationValue","departmentValue","locationValue","projectcodeValue","jobtypeValue","workshiftValue","hiringMgrValue","templateName","state","templateId","status","uuid"};
