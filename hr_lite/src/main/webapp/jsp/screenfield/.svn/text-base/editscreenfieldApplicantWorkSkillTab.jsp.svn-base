...
<td><b>Work Experience</b></td><td></td><td></td><td></td><td></td>
</tr>
<%
	...
	for(int i = 0; i < WORK_EXPERIENCE_List.size(); i++){ 
		screenFields = (ScreenFields)WORK_EXPERIENCE_List.get(i);
		String bgcolor = "";
...
<td><b>Skills</b></td><td></td><td></td><td></td><td></td>
</tr>
<%
	 screenFields= null;
	...
	for(int i = 0; i < SKIL_List.size(); i++){ 
		screenFields = (ScreenFields)SKIL_List.get(i);
		String bgcolor = "";
		if(i%2 == 0)bgcolor ="#e7e9fe";
	%>
