...
@XmlRootElement(name="WSException", namespace="http://user.webservice/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name="WSException", namespace="http://user.webservice/", propOrder={"errorCode", "errorDescription", "message"})
