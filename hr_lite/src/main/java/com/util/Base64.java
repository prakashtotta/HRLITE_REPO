...
public class Base64
{
    ...
    throws IOException
  {
    ...
    BufferedOutputStream b64os = null;
    GZIPOutputStream gzos = null;
    ObjectOutputStream oos = null;
    try
    {
      baos = new ByteArrayOutputStream();
      b64os = new BufferedOutputStream(baos, 0x1 | options);
      if ((options & 0x2) != 0)
      {
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      bos.write(dataToDecode.getBytes("US-ASCII")); return;
    }
    catch (IOException e)
    {
      throw e;
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      out.write(encoded.getBytes("US-ASCII")); return;
    }
    catch (IOException e)
    {
      throw e;
