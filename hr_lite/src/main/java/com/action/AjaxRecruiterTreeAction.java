...
public class AjaxRecruiterTreeAction
  extends BaseTreeViewAction
{
  protected static final Logger logger = Logger.getLogger(AjaxRecruiterTreeAction.class);
  ...
  {
    BOFactory.getTreeBO().ajaxRecruiterTree(treeViewId, treeNodeId, treeNodeRoot, mapping, form, request, response);
  }
