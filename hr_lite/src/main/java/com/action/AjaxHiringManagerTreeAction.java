...
public class AjaxHiringManagerTreeAction
  extends BaseTreeViewAction
{
  protected static final Logger logger = Logger.getLogger(AjaxHiringManagerTreeAction.class);
  ...
  {
    BOFactory.getTreeBO().ajaxHiringManagerTree(treeViewId, treeNodeId, treeNodeRoot, mapping, form, request, response);
  }
