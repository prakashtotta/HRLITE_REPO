...
public class AjaxReqTreeAction
  extends BaseTreeViewAction
{
  protected static final Logger logger = Logger.getLogger(AjaxReqTreeAction.class);
  ...
  {
    BOFactory.getTreeBO().ajaxReqTree(treeViewId, treeNodeId, treeNodeRoot, mapping, form, request, response);
  }
