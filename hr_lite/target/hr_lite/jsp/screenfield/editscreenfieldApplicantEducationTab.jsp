...
%>
  ...
  <!-- for group wise WORK_EXPERIENCE -->
<table id="table-1">
<tr bgcolor="gray" id="1.0" class="nodrop nodrag">
<td><b>Education details</b></td><td></td><td></td><td></td><td></td>
</tr>
<%
	...
	for(int i = 0; i < EDUCATION_DETAILS_List.size(); i++){ 
		screenFields = (ScreenFields)EDUCATION_DETAILS_List.get(i);
		String bgcolor = "";
 ...
 <!-- for group wise SKIL -->
<table id="table-2">
<tr bgcolor="gray" id="2.0" class="nodrop nodrag">
<td><b>Certification details</b></td><td></td><td></td><td></td><td></td>
</tr>
<%
	 screenFields= null;
	...
	for(int i = 0; i < CERTIFICATION_List.size(); i++){ 
		screenFields = (ScreenFields)CERTIFICATION_List.get(i);
		String bgcolor = "";
		if(i%2 == 0)bgcolor ="#e7e9fe";
	%>
