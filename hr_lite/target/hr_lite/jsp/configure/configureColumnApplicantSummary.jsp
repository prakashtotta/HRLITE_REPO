...
<SCRIPT>
 ...
 document.configureColumnsForm.action = "configureColumns.do?method=configureColumnsApplicantSummarySave&todata="+todata+"&fromdata="+fromdata;
...
<br>
<BODY>
<html:form action="/configureColumns.do?method=configureColumnsApplicantSummarySave" >
<table>
<tr>
<td width="20%"></td>
<td></td>
