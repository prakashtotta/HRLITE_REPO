...
function runreport(){
	...
	var tu = "/jsp/report/requisitions_opening_statistics.jsp?reportfilename=requistion_opening_stat.jasper&orgids="+orgids+"&deptids="+deptids+"&hiringMgrIds="+hiringmgrids+"&year="+years;
...
<br>
<span id="reportdata">
<h3><%=Constant.getResourceStringValue("home.Reports.Requisition_opening_statistics",user2.getLocale())%></h3>
<br>
