...
function runreport(){
	...
	var tu = "/jsp/report/eeo_report.jsp?reportfilename=EEO_new.jasper&orgids="+orgids+"&deptids="+deptids+"&hiringMgrIds="+hiringmgrids+"&year="+years;
...
<br>
<span id="reportdata">
<h3><%=Constant.getResourceStringValue("home.Reports.EEO",user2.getLocale())%></h3>
<br>
