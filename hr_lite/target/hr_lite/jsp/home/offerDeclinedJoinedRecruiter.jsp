...
List appList = BOFactory.getApplicantBO().getApplicantsByInterviewStateAndOfferDeclinedDateRecruiter(user1,Common.OFFER_DECLINED,new Integer(noofdaysoffset).intValue());
