...
<td colspan="4">
	...
	<tr><td><br><input type="submit" id="login" name="login" value="Login" class="button"></td><td><br><a class="button" href="alogin.do?method=forgotpasswordsag" target="new">Forgot password? </a></td>
	</tr>
