...
<span id="commentspan">
<html:form action="/agencyops.do?method=addcomment" styleId="commentadd">
<br>
...
<tr bgcolor="#f3f3f3">
<td>
<b><%=Constant.getResourceStringValue("hr.applicant.action.added.by",user1.getLocale())%></b>&nbsp;&nbsp; <%=commentdata.getCreatedBy().equals(user1.getFirstName()) ?"You":commentdata.getCreatedBy()+" "+bytype%>  &nbsp;&nbsp;&nbsp; <b><%=Constant.getResourceStringValue("hr.applicant.action.added.on",user1.getLocale())%> </b>&nbsp;&nbsp; <%=DateUtil.convertSourceToTargetTimezone(commentdata.getCreatedDate(), user1.getTimezone().getTimezoneCode(), user1.getLocale())%><br>
</td>
<tr>
<td>
<%
