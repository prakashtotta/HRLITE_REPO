...
//if(searchpagedisplay != null && searchpagedisplay.equals("yes")){
	dataList = BOFactory.getApplicantBO().searchOwnAgencyApplicantsForPagination(user1,fullname,reqid,prevorg,email,appdate,cri,applicantNo,interviewState,results,startIndex,dir_str,sort_str);
	totalSize = BOFactory.getApplicantBO().getCountOfsearchOwnAgencyApplicant(user1,fullname,reqid,prevorg,email,appdate,cri,applicantNo,interviewState);
//}else{
	//dataList = BOFactory.getApplicantBO().searchOwnAgencyApplicantsForPagination(user1,results,startIndex,dir_str,sort_str);
	//totalSize = BOFactory.getApplicantBO().getCountOfsearchOwnAgencyApplicant(user1);
//}
	

System.out.println(totalSize);
String[] fields = {"applicantId","fullName","email","phone","city","heighestQualification","interviewState","appliedDate","jobTitle","referrerName","ownername","uuid","createdBy"};
