...
String idlistval = (String)request.getAttribute("idlistval");
...
if(boxnu != -1 && boxnu != 99){
	var check1="false";
	var approvenum = 'userid_'+boxnu;
	var chechapprovenum=window.opener.document['systemRuleForm'][approvenum].value;
    var pary = window.opener.document['systemRuleForm'].idlistvaluser.value;
    ...
    var array1new=new Array();
		...
		if(check1=="false"){
			  ...
			  var username1 = '<input type="hidden" value="'+c_value+'" name="username_'+boxnu+'"/>';
			...
			var newspanvalue = spanstart+username1+userlink+userid1+isusergroup+spanend;
			...
			for(var i=0;i<array3.length;i++){
  			...
  			window.opener.document['systemRuleForm'].idlistvaluser.value=array3new+" "+id_value;
	   ...
	   document.createUserForm.action = "user.do?method=searchusers&boxnumber=<%=boxnumber%>&idlistval=<%=idlistval%>";
