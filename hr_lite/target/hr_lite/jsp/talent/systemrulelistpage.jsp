...
Map m = SystemRuleBO.getSystemRulesForPagination(new Long(orgId).longValue(),results,startIndex,dir_str,sort_str);

dataList = (List)m.get(Common.ORGS_LIST);
 
 totalSize = ((Integer)m.get(Common.ORGS_COUNT)).intValue();

	


String[] fields = {"systemRuleId","ruleName","createdBy","createdDate","ruleType","status","publishToEmpRef","publishToExternal","orgName","deptName","userNames"};
