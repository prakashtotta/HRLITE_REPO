...
List dataList = BOFactory.getCharBO().getGroupCharListForPagination(results,startIndex,dir_str,sort_str);


int totalSize = 0;


totalSize = BOFactory.getCharBO().getCountOfAllGroupsChar();
	

System.out.println("totalSize"+totalSize);

String[] fields = {"groupCharId","groupCharName","createdBy","createdDate"};
