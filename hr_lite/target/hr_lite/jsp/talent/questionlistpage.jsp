...
List dataList = BOFactory.getQuestionBO().getAllquestionsDetailsForPagination(user1,results,startIndex,dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getQuestionBO().getAllquestionsDetails(user1);
totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"questionId","questionName","questionType","typeVal"};
