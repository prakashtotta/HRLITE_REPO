...
function searchcri(){
	   ...
	   document.jobRequisitionForm.action = "jobreq.do?method=searchMyReqlistpage";
...
document.jobRequisitionForm.action = "jobreq.do?method=exporttoexcelAllSearchMyrequisition&type=<%=Common.HIRING_MGR_SEARCH_ROLE%>";
document.jobRequisitionForm.submit();
}
...
<table border="0" width="1000" class="div">
		...
		<tr>
			...
			<td>
			<span id="departments">
			<html:select styleClass="multipleselect" multiple="true" size="3" property="departmentId" >
...
<tr>
			...
			<td>
			<html:select name="jobRequisitionForm" styleClass="multipleselect" multiple="true" size="3" property="jobtypeId">
			...
			<td>
			<html:select name="jobRequisitionForm" styleClass="multipleselect" multiple="true" size="3" property="jobgradeId">
		...
		<tr>
			...
			<td>
			<html:select name="jobRequisitionForm" styleClass="multipleselect" multiple="true" size="3" property="budgetcodeId">
...
var formatUrl = function(elCell, oRecord, oColumn, sData) {
        ...
        var editreqd = "<a href='#' onMouseover=\"ddrivetip('<b>"+sData+"</b>','#DFDFFF')\"; onMouseout=hideddrivetip(); onClick=editJobReq('" + oRecord.getData("jobreqId") + "')"+ ">" + sData + "</a>";
...
var formatUrl1 = function(elCell, oRecord, oColumn, sData) {
	...
	var summaryUrl = function(elCell, oRecord, oColumn, sData) {
		if(oRecord.getData("statusUiValue")=="Active > Open"){
          elCell.innerHTML = "<a href='jobreq.do?method=requistionapplicantlist&backurl=jobreq.do?method=myjobreqList&state=0&requistionId=" + oRecord.getData("jobreqId")+ "&secureid=" + oRecord.getData("uuid") +"'"+ ">" + "<%=Constant.getResourceStringValue("aquisition.applicant.summary",user1.getLocale())%>" + "</a>";
		}
		};
