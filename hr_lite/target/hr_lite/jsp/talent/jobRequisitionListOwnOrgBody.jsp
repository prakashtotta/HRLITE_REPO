...
function searchcri(){
	   ...
	   document.jobRequisitionForm.action = "jobreq.do?method=searchownorgjobreqList";
...
document.jobRequisitionForm.action = "jobreq.do?method=exporttoexcelAllSearchMyrequisition&type=<%=Common.MY_ORG_REQUISITION_SEARCH_ROLE%>";
document.jobRequisitionForm.submit();
}
...
<html:form action="/jobreq.do?method=searchreqlistpage">
...
<tr>
			...
			<td>
			<html:select name="jobRequisitionForm" styleClass="multipleselect" size="3" multiple="true" property="jobtypeIds">
			...
			<td>
			<html:select name="jobRequisitionForm" styleClass="multipleselect" size="3" multiple="true" property="jobgradeIds">
		...
		<tr>
			...
			<td>
			<html:select name="jobRequisitionForm" styleClass="multipleselect" size="3" multiple="true" property="budgetcodeIds">
...
<tr>
<td>
<input type="submit" name="search" value="<%=Constant.getResourceStringValue("hr.button.search",user1.getLocale())%>" onClick="searchcri()">
<input type="button" name="reset" value="<%=Constant.getResourceStringValue("hr.button.reset",user1.getLocale())%>" onClick="resetData()">
<input type="button" name="export to excel" value="<%=Constant.getResourceStringValue("hr.button.exporttoexcel",user1.getLocale())%>" onClick="exportrequistions()">
</td>
<td></td>
</tr>
</table>
...
<div align="center">
	...
	<tr>
			<td><font color="green"><%=Constant.getResourceStringValue("aquisition.applicant.export.job.started",user1.getLocale())%> <a href="bulkuploadtask.do?method=mybulktasklist"><%=Constant.getResourceStringValue("aquisition.process.job.page",user1.getLocale())%></a></font></td>
			<td></td>
		</tr>
...
<div align="center">
	...
	<tr>
			<td><font color="green"><%=Constant.getResourceStringValue("Requisition.exportreq",user1.getLocale())%>
			</font></td>
			<td></td>
		</tr>
...
<%}%>
 ...
 <a  class="button" href="#" onClick="exportrequistions()"><%=Constant.getResourceStringValue("Requisition.exportrequisitions",user1.getLocale())%></a>&nbsp; &nbsp;  <a  class="button" href="#" onClick="configuareColumns();return false;"><%=Constant.getResourceStringValue("aquisition.applicant.Configuare_Columns",user1.getLocale())%></a>
