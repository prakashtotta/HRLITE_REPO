...
String sort = "refferalSchemeTypeId"; // default don't sort
...
List dataList = BOFactory.getRefferalSchemeBO().getRefferalSchemeDetailsForPagination(user1,results,startIndex);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getRefferalSchemeBO().getAllRefferalSchemeDetails(user1);
totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"refferalSchemeTypeId","refferalSchemeName","createdBy","createdDate","uom"};
