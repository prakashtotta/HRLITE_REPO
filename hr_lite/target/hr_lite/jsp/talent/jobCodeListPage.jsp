...
List dataList = BOFactory.getLovBO().getAllJobCodeDetailsForPagination(results,startIndex,dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getLovBO().getAllJobCodeDetails();
totalSize = allDataList.size();
	
System.out.println(totalSize);
String[] fields = 

{"jobcodeId","jobCode","jobName","jobDesc","jobResponsibility"};
