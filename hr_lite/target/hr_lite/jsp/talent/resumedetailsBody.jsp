...
<li><a href="applicant.do?method=applicantDetails&applicantId=<%=form.getApplicantId()%>&secureid=<%=form.getUuid()%>">
<%=Constant.getResourceStringValue("aquisition.applicant.details",user1.getLocale())%></a></li>
<li><a href="applicant.do?method=resumedetails&applicantId=<%=form.getApplicantId()%>&secureid=<%=form.getUuid()%>" rel="countrycontainer" class="selected"><%=Constant.getResourceStringValue("aquisition.applicant.Resume",user1.getLocale())%></a></li>
...
<li><a href="applicant.do?method=applicantReferenceDetails&applicantId=<%=form.getApplicantId()%>&secureid=<%=form.getUuid()%>" rel="countrycontainer"><%=Constant.getResourceStringValue("aquisition.applicant.References",user1.getLocale())%></a></li>
