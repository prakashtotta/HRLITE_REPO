...
<div align="center" class="msg">
	...
	<tr>
			<td><font color="white"><%=Constant.getResourceStringValue("applicant.onboarding.successfull",user1.getLocale())%></font></td>
...
<%}else {%>
  ...
  String tempurl1 = "<a href='#' onClick=window.open("+"'"+"jobreq.do?method=editjobreq&jobreqId="+sform.getRequitionId()+"'"+","+ "'"+"LocationPreview"+ "'"+","+"'"+"location=0,status=0,scrollbars=1,menubar=0,resizable=1,width=800,height=700"+"'"+")>"+sform.getRequisitionName()+"</a>";
		%>	
<tr>
<td>
...
<%=Constant.getResourceStringValue("applicant.Round.Requistion",user1.getLocale())%> #  <%=sform.getRequisitionName()%>
           ...
           <tr>
				...
				<td><%=Constant.getResourceStringValue("aquisition.applicant.Joined_date",user1.getLocale())%><font color="red">*</font></td>
      <td>
...
<A HREF="#" onClick="cal1xx.select(document.applicantForm.joineddate,'anchor1xx','<%=datepattern%>'); return false;" TITLE="Select date" NAME="anchor1xx" ID="anchor1xx">
