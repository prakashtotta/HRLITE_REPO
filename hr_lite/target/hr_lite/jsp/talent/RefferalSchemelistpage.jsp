...
String sort = "refferalScheme_Id"; // default don't sort
...
List dataList = BOFactory.getRefferalSchemeBO().getRefferalSchemeDetailsForPagination(user1,results,startIndex,dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = BOFactory.getRefferalSchemeBO().getCountOfAllRefferalSchemes(user1);


	

System.out.println(totalSize);
String[] fields = {"refferalScheme_Id","refferalScheme_Name","refferalScheme_Amount","refferalBudgetCodeStr","refferalSchemeName","ruleStr","uom","schemeType"};
