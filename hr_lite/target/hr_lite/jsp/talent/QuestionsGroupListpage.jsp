...
String sort = "questiongroupId"; // default don't sort
...
List dataList = BOFactory.getQuestionBO().getAllquestionsGroupDetailsForPagination(user1,results,startIndex,dir_str,sort_str);

System.out.println("size"+dataList.size());
int totalSize = 0;

List allDataList = BOFactory.getQuestionBO().getAllquestionsGroupDetails(user1);
totalSize = allDataList.size();
	

System.out.println(totalSize);
String[] fields = {"questiongroupId","questiongroupName","questiongroupDesc"};
