...
dataList = TaskBO.getBulkUploadTasksForPagination(user1,cri,assigneddate,createdBy,tasktype,status,results,startIndex,dir_str,sort_str);
totalSize = TaskBO.getCountOfBulkUploadTasks(user1,cri,assigneddate,createdBy,tasktype,status);
}else{
dataList = TaskBO.getBulkUploadTasksForPagination(results,startIndex,dir_str,sort_str);
totalSize = TaskBO.getCountOfBulkUploadTasks();
}


String[] fields = {"bulkuploadtaskid","tasktype","createdBy","uploadedFileName","status","filesList","successfilesList","failfilesList","createdDate","updatedDate"};
