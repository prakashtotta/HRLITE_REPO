...
function updatedata222(){
	alert(document.refferalForm.projectcodeId.value)
}
 ...
 var code = document.refferalForm.employeecode.value.trim();
  var name = document.refferalForm.employeename.value.trim();
   var email = document.refferalForm.employeeemail.value.trim();
	  ...
	  document.refferalForm.action = "refferal.do?method=updateRefferal&refferalid="+'<bean:write name="refferalForm" property="employeeReferalId"/>';
...
function deleteuser(){
	  ...
	  if (doyou == true){
	 	...
	 	document.refferalForm.action = "refferal.do?method=delete&employeeReferalId=<%=refform.getEmployeeReferalId()%>";
		document.refferalForm.submit();
...
function suspend(){
	  ...
	  var doyou = confirm("<%=Constant.getResourceStringValue("refferal.common.suspend",user1.getLocale())%>");
		  ...
		  document.refferalForm.action = "refferal.do?method=suspend&employeeReferalId=<%=refform.getEmployeeReferalId()%>";
		  document.refferalForm.submit();
...
function activate(){
	  ...
	  if (doyou == true){
 		...
 		document.refferalForm.action = "refferal.do?method=activate&employeeReferalId=<%=refform.getEmployeeReferalId()%>";
 		document.refferalForm.submit();
...
<body class="yui-skin-sam">
	...
	<tr>
			<td ><font color="green"><%=Constant.getResourceStringValue("hr.user.User_updated",user1.getLocale())%></font>
			 <!-- <a class="closelink" href="#" onclick="closewindow()"><%=Constant.getResourceStringValue("hr.button.close_window",user1.getLocale())%></a> --></td>
		</tr>
...
<div class="div" >
	...
	<tr>
			<td ><font color="green"><%=Constant.getResourceStringValue("hr.user.user_deleted_succ",user1.getLocale())%></font>
			<!--  <a class="closelink" href="#" onclick="closewindow()"><%=Constant.getResourceStringValue("hr.button.close_window",user1.getLocale())%></a> --></td>
		</tr>
...
<div class="div" >
	...
	<tr>
			<td ><font color="green"><%=Constant.getResourceStringValue("hr.user.user_suspended_succ",user1.getLocale())%></font>
			<!--  <a class="closelink" href="#" onclick="closewindow()"><%=Constant.getResourceStringValue("hr.button.close_window",user1.getLocale())%></a> --></td>
		</tr>
...
<div class="div" >
	...
	<tr>
			<td ><font color="green"><%=Constant.getResourceStringValue("hr.user.user_activated_succ",user1.getLocale())%></font>
			<!--  <a class="closlink" href="#" onclick="closewindow()"><%=Constant.getResourceStringValue("hr.button.close_window",user1.getLocale())%></a> --></td>
		</tr>
