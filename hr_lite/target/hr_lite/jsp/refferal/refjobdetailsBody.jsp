...
<div align="center" class="msg">
	...
	<tr>
			...
			<td><font color="white"><%=Constant.getResourceStringValue("Requisition.Bookmark_plz_click",user1.getLocale())%>  <a class="closelink" href="refjob.do?method=mybookmarks&requistionId=<%=form.getJobreqId()%>&secureid=<%=form.getUuid()%>"><%=Constant.getResourceStringValue("Requisition.My_bookmarks",user1.getLocale())%></a> </font></td>
		</tr>
...
<br><br>    
<font size="5" face="verdana"><b><%=Constant.getResourceStringValue("Requisition.jobreqdetails",user1.getLocale())%> - <font size="5"><b> <bean:write name="form" property="jobPosition"/></b></font>
</b></font>
		...
		<tr>
          ...
          <td align="left" > 
			  <% if(form.getStatus()!= null && form.getStatus().equals("Open") && form.getState().equals("Active") && jobapply != null && jobapply.equals("yes")){%>
				  <%if(user1 != null){%>
		           <a class="button" href="#" onClick="createapplicantRef('<%=appurl%>')"><%=Constant.getResourceStringValue("refferal.referafriend.upload.friend.profile",user1.getLocale())%></a> &nbsp;&nbsp;<a  class="button" href="#" onClick="javascript:addfriend('<%=form.getJobreqId()%>')"><%=Constant.getResourceStringValue("refferal.referafriend.ask.friend.to.upload.profile",user1.getLocale())%></a><br><br>
				  <%}else{%>
				  <a class="button" href="#" onClick="createapplicant()">Refer a friend</a> 
				  <%}%>
			  <%}%>
		  </td>
        </tr>
