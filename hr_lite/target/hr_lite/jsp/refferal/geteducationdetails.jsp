...
<html:form action="/applicantoffer.do?method=geteducationdetails" >
...
<%
String attachurl = "applicantoffer.do?method=actionattachmentaddscr&idvalue="+edu.getEducationId()+"&action=education_details_proof_attachment&applicantId="+aform.getApplicantId()+"&secureid="+aform.getUuid();
%>
<tr>
...
<%
		...
		String dleteurl = request.getContextPath()+"/applicantoffer.do?method=deleteattachment&actionname=education_details_proof_attachment&applicantId="+aform.getApplicantId()+"&secureid="+aform.getUuid()+"&uuid="+actionattach.getUuid();
...
title="<%=Constant.getResourceStringValue("Requisition.delete.attachment",user1.getLocale())%>" height="10"  width="9"/></a>
</td>
</tr>
<%
		}
...
<table valign="top" border="0" width="30%">
<%
String attachurl = "applicantoffer.do?method=actionattachmentaddscr&idvalue="+edu.getEducationId()+"&action=certification_details_proof_attachment&applicantId="+aform.getApplicantId()+"&secureid="+aform.getUuid();
%>
<tr>
...
<%
		...
		String dleteurl = request.getContextPath()+"/applicantoffer.do?method=deleteattachment&actionname=certification_details_proof_attachment&applicantId="+aform.getApplicantId()+"&secureid="+aform.getUuid()+"&uuid="+actionattach.getUuid();
