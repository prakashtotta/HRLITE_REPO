 ...
 */
var simpleTree;
var structureManagerURL = "jsp/reqtree/manageTreeData.jsp";
		...
		if (treeOps.ajaxActive == true)
		{
			...
			if(params.indexOf('changeOrder')>0){
				...
				if(elementIdtmp.indexOf("_")>0){
					var ok = confirm("It is only possible to move applicants,not folders");
					window.location.reload();
				}else if(desttoot2 == "=0"){
					var ok = confirm("It is only possible applicants to move folders");
					window.location.reload();
				}
